      ...
      <div className="mt-3 px-4 gap-4">
        ...
        <div className="col-span-3">
          <div className="p-3 bg-[#FFFFFF] gap-4 mt-3 rounded-lg">
            ...
            <div className="bg-[#F5F9FC] p-4 gap-3 w-[300px] h-32 rounded-lg my-3">
              <p className="bg-[#9DF6B42E] w-fit h-7 p-2 rounded-xl mb-2 text-[#303F58] font-semibold text-xs">Best First Responder</p>
              <img src="" alt="" />
              <p className="mb-2 text-[#4B5C79] text-xs font-normal">Fastest response time in the department</p>
            ...
            <div className="bg-[#F5F9FC] p-4 gap-3 w-72 h-32 rounded-lg mb-3">
              <p className="bg-[#9DF6B482] w-fit h-7 p-2 rounded-xl mb-2 text-[#303F58] font-semibold text-xs">Customer Hero Award</p>
              <img src="" alt="" />
              <p className="mb-2 text-[#4B5C79] text-xs font-normal">Perfect feedback rating</p>
              <p className="text-[#303F58] font-normal text-xs">Date Received: <span className="font-bold">"August 2024"</span></p>
            </div>
            <div className="bg-[#F5F9FC] p-4 gap-3 w-72 h-32 rounded-lg mb-3">
              <p className="bg-[#1A9CF91A] w-fit h-7 p-2 rounded-xl mb-2 text-[#303F58] font-semibold text-xs"> Employee of the Month</p>
              <img src="" alt="" />
              <p className="mb-2 text-[#4B5C79] text-xs font-normal">Recognized for excellence</p>
