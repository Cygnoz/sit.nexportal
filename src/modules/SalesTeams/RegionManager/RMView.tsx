...
const RMView = () => {
  ...
  // Data for the table
  const data: AreaData[] = [
    { areaCode: "AR-NE001", areaName: "Area 1",  region: "Region 1", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 2",region: "Region 2", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 3",  region: "Region 3", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 4", region: "Region 4", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 5",  region: "Region 5", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 6", region: "Region 6", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 7", region: "Region 7", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 8",region: "Region 8", areaManagers: "ILorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 9",  region: "Region 9", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 10",  region: "Region 10", areaManagers: "Lorem ipsum dolor sise cillum d" },
    { areaCode: "AR-NE001", areaName: "Area 11",  region: "Region 11", areaManagers: "Lorem ipsum dolor sise cillum d" },
   ];
...
<div className="flex ms-16 mt-2">
    ...
    <div className=" text-end w-48">
        <p className="text-xs text-[#8F99A9] py-2">Role</p>
        <h3 className="text-xs">Regional Manager</h3>
    </div>

    <div className="text-center w-24">
        <p className="text-xs text-[#8F99A9] py-2">Employee ID</p>
        <p className="text-xs">EMC-NEOO1</p>
    </div>

    <div className="text-center w-24">
        <p className="text-xs text-[#8F99A9] py-2">Joining Date</p>
