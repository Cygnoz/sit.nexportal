...
const PayrollView = ({ }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="bg-white font-bold text-base mt-2 rounded-lg">
        ...
        <div className="p-2 me-2 flex justify-end gap-4">
          {!isEditing ? (
            ...
            //   Edit
            // </button>
            <Button variant="tertiary" onClick={handleEdit} className="w-28 h-10 justify-center text-sm rounded-lg text-[#565148] font-medium">
              <EditIcon color="#565148" size={16} />
              Edit
              </Button>
          ) : (
            <>
              ...
              <Button variant="primary" className="w-28 h-10 justify-center text-sm rounded-lg text-[#FEFDF9] font-medium">Apply</Button>
      ...
      <Button variant="tertiary" className="w-36 h-10 justify-center text-sm rounded-lg text-[#565148] font-medium">Cancel</Button>
      <Button variant="primary" className="w-36 h-10 justify-center text-sm rounded-lg text-[#FEFDF9] font-medium">Submit</Button>
      </div>
