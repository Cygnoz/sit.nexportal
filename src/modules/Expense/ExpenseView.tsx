        ...
        <div>
            ...
            <div className="w-full bg-[#FFFFFF] p-6 rounded-2xl gap-6">
                <div className="flex gap-4">
                    ...
                    <button className="justify-center text-[#FFFFFF] font-medium text-xs bg-[#C4A25D] rounded-md w-32 h-5">Pending generated</button>
                </div>
                ...
                <div className="">
                 ...
                 <div className=" flex justify-end gap-2 mt-6 pb-2 ">
                          ...
                          <Button
                            variant="primary"
                            className="w-36 h-10 justify-center text-sm rounded-lg text-[#FEFDF9] font-medium border border-[#585953]"
                            size="lg"
                            type="submit"
                          >
                            Approve
