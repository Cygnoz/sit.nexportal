...
pipeline {
    ...
    environment {
        ...
        ECR_REPOSITORY = 'nexsell/leads'
        IMAGE_NAME = 'nexsell/leads'
        ...
        ECS_SERVICE_NAME = 'nexsell-leads' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'nexsell-leads' // Replace with your ECS task definition name
    }
