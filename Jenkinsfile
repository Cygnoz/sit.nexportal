pipeline {
    ...
    environment {
        ...
        ECR_REPOSITORY = 'sit-nexsell-frontend'
        ...
        ECS_SERVICE_NAME = 'sit-nexsell-frontend' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'sit-nexsell-frontend' // Replace with your ECS task definition name
    }
