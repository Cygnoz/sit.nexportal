pipeline {
    ...
    environment {
        ...
        ECR_REPOSITORY = 'sit-nexsell-ticket'
        IMAGE_NAME = 'nexsell/tickets'
        AWS_CREDENTIALS_ID = '2157424a-b8a7-45c0-90c2-bc0d407f6cea'
        AWS_ACCOUNT_ID = '654654462146' // Add your AWS account ID here
        SONARQUBE_PROJECT_KEY = 'sit.nexsell.tickets'
        SONARQUBE_SCANNER_CREDENTIALS_ID = '6408f6dd-bc00-4a13-9dac-6bc69ea83d75' // Jenkins credentials ID for SonarQube token
        ECS_CLUSTER_NAME = 'sit-nexsell' // Replace with your ECS cluster name
        ECS_SERVICE_NAME = 'sit-nexsell-ticket' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'sit-nexsell-ticket' // Replace with your ECS task definition name
    }
